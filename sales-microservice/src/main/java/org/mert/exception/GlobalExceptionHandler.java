...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SaleMicroserviceExecption.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroseviceException(SaleMicroserviceExecption exception){
