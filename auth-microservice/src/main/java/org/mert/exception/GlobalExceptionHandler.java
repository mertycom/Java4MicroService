...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AuthMicroserviceExecption.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroseviceException(AuthMicroserviceExecption exception){
