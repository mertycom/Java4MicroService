...
import static org.mert.exception.ErrorType.*;
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UserProfileMicroserviceExecption.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroseviceException(UserProfileMicroserviceExecption exception){
