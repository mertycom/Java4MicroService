...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ProductMicroserviceExecption.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroseviceException(ProductMicroserviceExecption exception){
